...
import kuli.wzq.springframework.beans.factory.config.BeanFactoryPostProcessor;
...
import kuli.wzq.springframework.context.ConfigurableApplicationContext;
import kuli.wzq.springframework.context.event.ApplicationEventMulticaster;
import kuli.wzq.springframework.context.event.ContextClosedEvent;
import kuli.wzq.springframework.context.event.ContextRefreshedEvent;
import kuli.wzq.springframework.context.event.SimpleApplicationEventMulticaster;
...
public abstract class AbstractApplicationContext extends DefaultResourceLoader implements ConfigurableApplicationContext {
    ...
    public void refresh() throws BeansException {
        ...
        //5、BeanPostProcessor需要提前于其他Bean对象实例化前注册
